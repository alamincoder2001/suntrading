        ...
        $transactions = $this->db->query("
            select * from(
                ...
                select 
                    ...
                    concat('Purchase invoice ', pm.PurchaseMaster_InvoiceNo ) as description,
                    pm.account_id,
                    pm.PurchaseMaster_OrderDate ,
                    pm.payment_type,
                    0.00 as deposit,
                    pm.PurchaseMaster_PaidAmount as withdraw,
                    pm.PurchaseMaster_Description,
                    ac.account_name,
                    ac.account_number,
                    ac.bank_name,
                    ac.branch_name,
                ...
                select 
                    ...
                    concat('Sale invoice ', sm.SaleMaster_InvoiceNo  ) as description,
                    sm.account_id,
