									...
									<tr>
										<td>
											<div class="form-group">
												...
												<div class="col-xs-12">
													<select v-model="purchase.payment_method" id="" class="form-control" style="border-radius: 4px;padding:0px 4px;">
		...
		methods: {
			...
			async getPurchase() {
				await axios.post('/get_purchases', {
					...
					this.purchase.payment_method = purchase.payment_type;
					this.purchase.bank_name = purchase.account_id;
